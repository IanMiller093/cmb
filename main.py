...
plot_2d_ps(full_b_map, "full_sim_beam_2dps")
plot_2d_ps(full_nb_map, "full_sim_no_beam_2dps")
plot_2d_ps(cmb_b_map, "cmb_beam_2dps")
plot_2d_ps(cmb_nb_map, "cmb_no_beam_2dps")
plot_2d_ps(dust_b_map, "dust_beam_2dps")
plot_2d_ps(dust_nb_map, "dust_no_beam_2dps")
plot_2d_ps(rotated_dust_b_map, "rotated_dust_beam_2dps")
plot_2d_ps(rotated_dust_nb_map, "rotated_dust_no_beam_2dps")
plot_2d_ps(rotated_full_b_map, "rotated_full_sim_beam_2dps")
plot_2d_ps(rotated_full_nb_map, "rotated_full_sim_no_beam_2dps")