...
# get sim
full_b_map = make_cmb_and_foreground(dec_radius=4, ra_radius=8, ps_txt_filepath="ps.txt", seed=67, res=1, sky_f=150, foreground_components=["d0"], beam=True, fwhm=1)
full_nb_map = make_cmb_and_foreground(dec_radius=4, ra_radius=8, ps_txt_filepath="ps.txt", seed=67, res=1, sky_f=150, foreground_components=["d0"], beam=False, fwhm=1)
...
cmb_b_map, _ = make_cmb(dec_radius=4, ra_radius=8, ps_txt_filepath="ps.txt", seed=67, res=1, fwhm=1, beam=True)
cmb_nb_map, _ = make_cmb(dec_radius=4, ra_radius=8, ps_txt_filepath="ps.txt", seed=67, res=1, fwhm=1, beam=False)
noise_b_map = make_noise(dec_radius=4, ra_radius=8, res=1, beam=True, fwhm=1)
noise_nb_map = make_noise(dec_radius=4, ra_radius=8, res=1, beam=False, fwhm=1)
dust_b_map = make_foreground(dec_radius=4, ra_radius=8, sky_f=150, res=1, foreground_components=["d0"], fwhm=1, beam=True)
dust_nb_map = make_foreground(dec_radius=4, ra_radius=8, sky_f=150, res=1, foreground_components=["d0"], fwhm=1, beam=False)
