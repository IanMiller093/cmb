...
plot_2d_ps(full_b_map, "image_outputs/full_sim_beam_2dps")
plot_2d_ps(full_nb_map, "image_outputs/full_sim_no_beam_2dps")
plot_2d_ps(cmb_b_map, "image_outputs/cmb_beam_2dps")
plot_2d_ps(cmb_nb_map, "image_outputs/cmb_no_beam_2dps")
plot_2d_ps(dust_b_map, "image_outputs/dust_beam_2dps")
plot_2d_ps(dust_nb_map, "image_outputs/dust_no_beam_2dps")
plot_2d_ps(rotated_dust_b_map, "image_outputs/rotated_dust_beam_2dps")
plot_2d_ps(rotated_dust_nb_map, "image_outputs/rotated_dust_no_beam_2dps")
plot_2d_ps(rotated_full_b_map, "image_outputs/rotated_full_sim_beam_2dps")
plot_2d_ps(rotated_full_nb_map, "image_outputs/rotated_full_sim_no_beam_2dps")
plot_2d_ps(noise_b_map, "image_outputs/noise_beam_2dps")
plot_2d_ps(noise_nb_map, "image_outputs/noise_no_beam_2dps")